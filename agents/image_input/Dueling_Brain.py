...
class Learning(AbstractBrain.AbstractLearning):
    ...
    def __init__(self, observations, actions, config):
        ...
        self.e_greedy_formula = 'e = 5.45^(-0.001*(episode-initial_epsilon_episodes))'
        self.epsilon = 1.0
    ...
    def update_epsilon(self, episode):
        ...
        self.epsilon = \
            max(self.config['min_epsilon'], 5.45 ** (-0.001 * (episode - self.config['initial_epsilon_episodes'])))

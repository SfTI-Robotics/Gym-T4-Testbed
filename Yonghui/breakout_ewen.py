...
class Estimator():
    ...
    def update(self, sess, s, a, y):
        ...
        return loss
# As mentioned in DQN paper, there are two network that share the same parameters in DQN algorithm. We need to copy the parameters to the target network on each [Math Processing Error] steps.
